...
const SignUp = () => {
  ...
  const handleCreateAccount = () => {
    ...
    // Navigate to course welcome page with name passed via state
    navigate("/course", { state: { userName: fullName } });
  };
    ...
    <div className="min-h-screen w-full bg-[#080808] flex items-center justify-center px-4"
      ...
      <div className="relative z-10 w-full max-w-md bg-[#111111] border border-orange-500/25 rounded-2xl p-10 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-white mt-3 mb-1">Create Account</h2>
          <p className="text-sm text-gray-500">Join 1 Million+ students at Pro Academy</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <Link to="/signin" className="text-orange-500 font-semibold hover:text-orange-400 transition-colors">
            Log In
          </Link>
        </p>
      </div>
